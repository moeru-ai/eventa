...
export default defineConfig({
  entry: {
    'index': 'src/index.ts',
    'adapters/broadcast-channel/index': 'src/adapters/broadcast-channel/index.ts',
    ...
    'adapters/tauri/index': 'src/adapters/tauri/index.ts',
    'adapters/unix-socket/index': 'src/adapters/unix-socket/index.ts',
